...
Source0  : https://cran.r-project.org/src/contrib/MALDIquant_1.22.3.tar.gz
...
%prep
%setup -q -n MALDIquant
pushd ..
cp -a MALDIquant buildavx2
popd
pushd ..
cp -a MALDIquant buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724118417
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/MALDIquant/libs/MALDIquant.so
/V4/usr/lib64/R/library/MALDIquant/libs/MALDIquant.so
