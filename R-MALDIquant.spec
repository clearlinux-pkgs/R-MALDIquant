...
Version  : 1.20
Release  : 31
URL      : https://cran.r-project.org/src/contrib/MALDIquant_1.20.tar.gz
Source0  : https://cran.r-project.org/src/contrib/MALDIquant_1.20.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627601721
